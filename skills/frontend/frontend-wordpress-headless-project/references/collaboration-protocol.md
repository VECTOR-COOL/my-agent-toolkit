# Frontend Builder Collaboration Protocol
...
| Area | AI builder / platform | Cursor / Git |
| --- | --- | --- |
...
| Code architecture, CMS integration, service layer | Can generate local patches | Owns durable implementation |
...
- Check whether the task belongs to platform operations, code work, or WordPress CMS work.
