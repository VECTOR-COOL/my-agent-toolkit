...
```text
請為這個專案建立 Lovable Knowledge file。
...
- Lovable 必須保留的 files 與 architecture rules
...
```text
請建立 Lovable TanStack Start app 的 project foundation。
...
Prompt 可以保留英文欄位名稱與技術片語，因為 Lovable 對清楚的英文任務欄位通常反應穩定；但任務描述、規則與限制預設使用中文，方便後續維護與討論。
