...
Use `.agents/skills/wordpress-rest-api-development` for detailed WordPress REST schemas, TypeScript examples, mock templates, service-layer examples, and validation scripts.
